...
echo "*****************************************************************"
echo "* iRobot2D 2008 - Birjand-Robotic Institute -I.R.IRAN           *"
echo "* Base code version                                             *"
echo "* Created by:           Saeed Rahmani                           *"
echo "* 		      Hussein Shirvani			      *"
echo "*			      Milad Mohammadi			      *"
echo "*								      *"
echo "*	Research Coordinator: Hossein Shirvani                        *" 
echo "* Team Coordinator:     Milad Mohammadi                         *"
echo "* Copyright 2007-2008.  Birjand-Robotic Institute               *"
echo "* Under Licence Of GNU                                          *"
echo "*****************************************************************"
